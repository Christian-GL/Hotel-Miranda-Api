...
var contactModelMongodb_1 = require("./src/models/mongodb/contactModelMongodb");
        ...
        switch (_b.label) {
            ...
            case 3:
                ...
                fakeUser = new userModelMongodb_1.UserModelMongodb({
                    ...
                    start_date: faker_1.faker.date.future().toISOString(),
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                totalErrors = void 0;
                for (i = 0; i < 25; i++) {
                    fakeContact = new contactModelMongodb_1.ContactModelMongodb({
                        full_name: faker_1.faker.person.fullName(),
                        email: faker_1.faker.internet.email(),
                ...
                return [4 /*yield*/, contactModelMongodb_1.ContactModelMongodb.insertMany(contacts)];
            case 3:
                _a.sent();
                return [3 /*break*/, 5];
            case 4:
